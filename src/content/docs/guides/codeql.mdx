...
description: What --codeql adds to the call graph, how codeanalyzer downloads and caches the CodeQL CLI and database, and the resolution ladder that maps CodeQL endpoints back to Jedi signatures.
---
